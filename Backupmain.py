...
#BOTTOM FRAME--------------------------
        ...
        self.submit_button = Tk.Button(self.bottom_frame, text='Submit', command=self.save_to_database, width=35, height=1, font=self.label_size)
        self.cancel_button = Tk.Button(self.bottom_frame, text='Cancel', command=self.cancel_entry, width=35, height=1, font=self.label_size)
